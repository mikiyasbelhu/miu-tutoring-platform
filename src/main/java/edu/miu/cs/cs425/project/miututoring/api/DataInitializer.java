...
public class DataInitializer implements CommandLineRunner {
    ...
    public DataInitializer(FacultyService facultyService, StudentService studentService,
                           ...
                           PasswordEncoder passwordEncoder, EnrollmentService enrollmentService, ReportService reportService, TutorRequestService tutorRequestService) {
    ...
    public void run(String... args) throws Exception {
        ...
        // Faculty
        Faculty faculty1 = new Faculty("faculty1@miu.edu", "faculty", "Obinna", "A", "Kalu", "Software Engineering CS425");
        Faculty faculty2 = new Faculty("faculty2@miu.edu", "faculty1", "Michael", "", "Zijlstra", "Modern Programming Practices CS401");
        ...
        // Tutorial Group
        TutorialGroup tutorialGroup1 = new TutorialGroup("CS425", section1);
        TutorialGroup tutorialGroup2 = new TutorialGroup("CS425", section1);
        TutorialGroup tutorialGroup3 = new TutorialGroup("CS401", section2);
        TutorialGroup tutorialGroup4 = new TutorialGroup("CS401", section2);
        ...
        // Enrollment
        Enrollment enrollment = new Enrollment(student1, section1);
        ...
        //Tutor Request
        TutorRequest request1 = new TutorRequest(section1, enrollment, "I have 4 years experience teaching students");
        saveTutorialRequest(request1);
        TutorRequest request2 = new TutorRequest(section2,enrollment1, "I have 2 years experience in the tech industry");
        saveTutorialRequest(request2);

        //Report
        Report report1 = new Report(student3, tutorialGroup1, course1, "This student is progressing really well");
        saveReport(report1);
